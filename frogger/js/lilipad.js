//The lilypad moves right to left and transports the frog in the river.
function Lilipad (lane, xPos) {
	...
	this.xPos = xPos
	this.attached = false
	//the number of lilypads that are next to each other.
	this.lilipadCount = 3
	this.height = 50
...
_.extend(Lilipad.prototype, {
	render: function (game) {
		...
		//each lilpad is generated by taking two half circles and super imposing them at an angle.
